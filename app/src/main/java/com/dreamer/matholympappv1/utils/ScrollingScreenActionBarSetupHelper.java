...
public class ScrollingScreenActionBarSetupHelper {
    ...
    public void setupActionBar(@NonNull LayoutInflater inflater, @NonNull String title, @NonNull String score) {
        ...
        if (myAppBarTitleTextView != null) {
            ...
            android.util.Log.e("TAG", "ScrollingScreenActionBarSetupHelper: Title set to: " + title);
        } else {
            android.util.Log.e("TAG", "ScrollingScreenActionBarSetupHelper: ERROR - appBarTVtitle is NULL");
        }
